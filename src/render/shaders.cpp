...
glew::GLuint load_shaders()
{
  ...
  if ( InfoLogLength > 0 ){
    ...
    glew::glGetShaderInfoLog(VertexShaderID, InfoLogLength, NULL, &VertexShaderErrorMessage[0]);
  ...
  if ( InfoLogLength > 0 ){
    ...
    glew::glGetShaderInfoLog(FragmentShaderID, InfoLogLength, NULL, &FragmentShaderErrorMessage[0]);
  ...
  if ( InfoLogLength > 0 ){
    ...
    glew::glGetProgramInfoLog(ProgramID, InfoLogLength, NULL, &ProgramErrorMessage[0]);
