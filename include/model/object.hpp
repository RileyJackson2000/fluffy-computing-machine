...
protected:
  ...
  Object( // only statics
      ...
      glm::dvec3 centroid, Material mat, double mass, double moment_of_inertia)
  ...
  Object( // statics + kinematics
      ...
      glm::dvec3 force, glm::dvec3 torque, Material mat, double mass,
...
public:
  ...
  Sphere(std::string name, glm::dvec3 position, double radius, Material mat)
      : Object{std::move(name),
               ...
               density(mat) * 8. / 15. * pi * radius * radius * radius *
